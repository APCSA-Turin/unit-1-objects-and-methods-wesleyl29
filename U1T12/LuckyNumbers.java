public class LuckyNumbers {
  ...
  public String getLuckyNumbers() {
    String x = "Your lucky numbers are: "+randomIntegerBetween(1, 65)+" "+randomIntegerBetween(1, 65)+" "+randomIntegerBetween(1, 65)+" "+randomIntegerBetween(1, 65)+" "+randomIntegerBetween(1, 65)+" "+"\n"+
